...
DEFINE_PTHREADPOOL_FUNCTION(parallelize_1d_with_thread,
                            pthreadpool_t threadpool,
...
DEFINE_PTHREADPOOL_FUNCTION(parallelize_1d_with_uarch, pthreadpool_t threadpool,
                            pthreadpool_task_1d_with_id_t function,
                            void* context, uint32_t default_uarch_index,
                            uint32_t max_uarch_index, size_t range,
                            uint32_t flags) {
  LOG(FATAL) << "Not implemented";
}
...
DEFINE_PTHREADPOOL_FUNCTION(parallelize_2d_with_thread,
                            pthreadpool_t threadpool,
...
DEFINE_PTHREADPOOL_FUNCTION(parallelize_2d_tile_1d_with_uarch,
                            pthreadpool_t threadpool,
                            pthreadpool_task_2d_tile_1d_with_id_t function,
                            void* context, uint32_t default_uarch_index,
                            uint32_t max_uarch_index, size_t range_i,
                            size_t range_j, size_t tile_j, uint32_t flags) {
  LOG(FATAL) << "Not implemented";
}

DEFINE_PTHREADPOOL_FUNCTION(
    parallelize_2d_tile_1d_with_uarch_with_thread, pthreadpool_t threadpool,
...
DEFINE_PTHREADPOOL_FUNCTION(
    parallelize_2d_tile_2d_dynamic_with_uarch, pthreadpool_t threadpool,
...
DEFINE_PTHREADPOOL_FUNCTION(parallelize_3d_tile_1d_with_thread,
                            pthreadpool_t threadpool,
...
DEFINE_PTHREADPOOL_FUNCTION(parallelize_3d_tile_1d_with_uarch,
                            pthreadpool_t threadpool,
                            pthreadpool_task_3d_tile_1d_with_id_t function,
                            void* context, uint32_t default_uarch_index,
                            uint32_t max_uarch_index, size_t range_i,
                            size_t range_j, size_t range_k, size_t tile_k,
                            uint32_t flags) {
  LOG(FATAL) << "Not implemented";
}

DEFINE_PTHREADPOOL_FUNCTION(
    parallelize_3d_tile_1d_with_uarch_with_thread, pthreadpool_t threadpool,
...
DEFINE_PTHREADPOOL_FUNCTION(parallelize_3d_tile_2d_with_uarch,
                            pthreadpool_t threadpool,
                            pthreadpool_task_3d_tile_2d_with_id_t function,
                            void* context, uint32_t default_uarch_index,
                            uint32_t max_uarch_index, size_t range_i,
                            size_t range_j, size_t range_k, size_t tile_j,
                            size_t tile_k, uint32_t flags) {
  LOG(FATAL) << "Not implemented";
}

DEFINE_PTHREADPOOL_FUNCTION(
    parallelize_3d_tile_2d_dynamic_with_uarch, pthreadpool_t threadpool,
...
DEFINE_PTHREADPOOL_FUNCTION(parallelize_4d, pthreadpool_t threadpool,
...
DEFINE_PTHREADPOOL_FUNCTION(parallelize_4d_tile_1d, pthreadpool_t threadpool,
                            pthreadpool_task_4d_tile_1d_t function,
                            void* context, size_t range_i, size_t range_j,
                            size_t range_k, size_t range_l, size_t tile_l,
                            uint32_t flags) {
  LOG(FATAL) << "Not implemented";
}
...
DEFINE_PTHREADPOOL_FUNCTION(parallelize_4d_tile_2d_with_uarch,
                            pthreadpool_t threadpool,
                            pthreadpool_task_4d_tile_2d_with_id_t function,
                            void* context, uint32_t default_uarch_index,
                            uint32_t max_uarch_index, size_t range_i,
                            size_t range_j, size_t range_k, size_t range_l,
...
DEFINE_PTHREADPOOL_FUNCTION(parallelize_5d_tile_1d, pthreadpool_t threadpool,
...
DEFINE_PTHREADPOOL_FUNCTION(parallelize_6d, pthreadpool_t threadpool,
...
DEFINE_PTHREADPOOL_FUNCTION(parallelize_6d_tile_1d, pthreadpool_t threadpool,
                            pthreadpool_task_6d_tile_1d_t function,
                            void* context, size_t range_i, size_t range_j,
                            size_t range_k, size_t range_l, size_t range_m,
                            size_t range_n, size_t tile_n, uint32_t flags) {
  LOG(FATAL) << "Not implemented";
}

DEFINE_PTHREADPOOL_FUNCTION(parallelize_6d_tile_2d, pthreadpool_t threadpool,
                            pthreadpool_task_6d_tile_2d_t function,
                            void* context, size_t range_i, size_t range_j,
                            size_t range_k, size_t range_l, size_t range_m,
                            size_t range_n, size_t tile_m, size_t tile_n,
                            uint32_t flags) {
  LOG(FATAL) << "Not implemented";
}
